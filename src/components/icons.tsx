...
/** Two columns — the split-view marker on a tab holding several documents. */
export function Columns({ size = 16, ...props }: IconProps) {
    return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
            <rect x="3" y="3" width="18" height="18" rx="2" ry="2" />
...
/** Out of the box and away — "move this pane back to a tab of its own". */
export function PopOut({ size = 16, ...props }: IconProps) {
    return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
/** Downward arrow into a tray: "write this out as a file". */
